...
<html>
    ...
    <body bgcolor="gray">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
          <tr>
              <td width="30%">
                  <s:a href="http://localhost:8080/StrutsTest/dateTimeManager/addDay.jsp">增加日程</s:a>
              </td>
              <td width="30%">
                  <s:a href="http://localhost:8080/StrutsTest/dateTimeManager/lookDay.jsp">查看日程</s:a>
              </td>
              <td width="40%">
      ...
      <table border="5" cellspacing="0" cellpadding="0" bgcolor="#95BDFF" width="60%" align="center">
          ...
          <%
            ...
            %>
            <div align="center"><%="您还没有任何日程安排！"%></div>
            <%
        }else{
            for(int i=day.size()-1;i>=0;i--){
                ...
                %>
                    <tr>
                        ...
                        <td><%=dd.getThing()%></td>
                        <td>
                         <s:a href="http://localhost:8080/StrutsTest/dateTimeManager/updateDay.jsp">修改</s:a>
                         <s:a href="deleteDayAction.action">删除</s:a>
                     </td>
                    </tr>
                    <%
                }
