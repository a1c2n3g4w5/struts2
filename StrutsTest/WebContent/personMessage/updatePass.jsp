...
<html>
    ...
    <body bgcolor="gray">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
          <tr>
              <td width="33%">
                  <s:a href="http://localhost:8080/StrutsTest/personMessage/updateMessage.jsp">修改个人信息</s:a>
              </td>
              <td width="33%">
                  <s:a href="http://localhost:8080/StrutsTest/personMessage/lookMessage.jsp">查看个人信息</s:a>
              </td>
              <td width="33%">
      ...
      <table border="5" cellspacing="0" cellpadding="0" bgcolor="#95BDFF" width="60%" align="center">
          <%
            ...
            if(login==null||login.size()==0){
                response.sendRedirect("http://localhost:8080/StrutsTest/login/index.jsp");
            }else{
