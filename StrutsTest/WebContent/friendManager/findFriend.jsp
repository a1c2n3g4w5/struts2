...
<html>
    ...
    <body bgcolor="gray">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
          <tr>
              <td width="33%">
                  <s:a href="http://localhost:8080/StrutsTest/friendManager/addFriend.jsp">增加联系人</s:a>
              </td>
              <td width="33%">
                  <s:a href="http://localhost:8080/StrutsTest/friendManager/lookFriends.jsp">查看联系人</s:a>
              </td>
              <td width="33%">
      ...
      <table border="5" cellspacing="0" cellpadding="0" bgcolor="#95BDFF" width="60%" align="center">
          ...
          <%
            ...
            %>
            <div align="center"><%="您还没有添加联系人！"%></div>
            <%
            }else{
                for(int i=friends.size()-1;i>=0;i--){
                   ...
                   <tr>
                     ...
                     <td><%=ff.getQQ()%></td>
                     <td>
                         <s:a href="http://localhost:8080/StrutsTest/friendManager/updateFriend.jsp">修改</s:a>
                         
                         <s:a href="deleteFriAction.action">删除</s:a>
                     </td>
                   </tr>
                    <%
                }
