...
public class DB implements ServletRequestAware{
    ...
    private String url="jdbc:microsoft:sqlserver://localhost:1433;databaseName=InfSys";
   ...
   public String getDriverName() {
    ...
    public Statement getStatement(){
        try{
        	String dbUrl="jdbc:sqlserver://localhost:1433;DatabaseName=InfSys"; 
  ...
  public String insertMess(HttpServletRequest request,String userName,String password,String name,String sex,String birth,String nation,String edu,String work,String phone,String place,String email){
        try{
            ...
            if(rs.next()){
                ...
                String sql="insert into sysuser"+"(userName,password,name,sex,birth,nation,edu,work,phone,place,email)"+"values("+"'"+userName+"'"+","+"'"+password+"'"+","+"'"+name+"'"+","+"'"+sex+"'"+","+"'"+birth+"'"+","+"'"+nation+"'"+","+"'"+edu+"'"+","+"'"+work+"'"+","+"'"+phone+"'"+","+"'"+place+"'"+","+"'"+email+"'"+")";
                st=getStatement();
    ...
    public String updateMess(HttpServletRequest request,String userName,String name,String sex,String birth,String nation,String edu,String work,String phone,String place,String email){
        try{
            String sure=null;
            String sql="update sysuser set name='"+name+"',sex='"+sex+"',birth='"+birth+"',nation='"+nation+"',edu='"+edu+"',work='"+work+"',phone='"+phone+"',place='"+place+"',email='"+email+"' where userName='"+userName+"'";
            st=getStatement();
            int row=st.executeUpdate(sql);
            if(row==1){
                //调用，myMessage方法，更新session中保存的用户信息
    ...
    public String updatePass(HttpServletRequest request,String userName,String password){
        try{
            String sure=null;
            String sql="update sysuser set password='"+password+"' where userName='"+userName+"'";
            st=getStatement();
            int row=st.executeUpdate(sql);
            if(row==1){
