...
<html>
    ...
    <body bgcolor="gray">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
          <tr>
              <td width="33%">
                  <s:a href="http://localhost:8084/ch04/personMessage/updateMessage.jsp">修改个人信息</s:a>
              </td>
              <td width="33%">
                  <s:a href="http://localhost:8084/ch04/personMessage/lookMessage.jsp">查看个人信息</s:a>
              </td>
              <td width="33%">
